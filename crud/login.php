...
<body>
  ...
  <div class="center">
    ...
    <div class="form">
          ...
          <div class="forgetpassword" onclick="message()"><a href="FORGET.php" class="link">forget password ?</a></div>
          <input type="submit" name="login" value="login" class="btn">
          <div class="signup">New Member ?<a href="index.php" class="link">sign up here</a></div>
